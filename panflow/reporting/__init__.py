...
def generate_duplicate_objects_report(
    ...
    **kwargs,
    ...
    _warn_deprecated_import()
    engine = ReportingEngine(tree, device_type, context_type, version)
    return engine.generate_duplicate_objects_report(output_file=output_file, **kwargs)
...
def generate_security_rule_coverage_report(
    ...
    **kwargs,
    ...
    _warn_deprecated_import()
    engine = ReportingEngine(tree, device_type, context_type, version)
    return engine.generate_security_rule_coverage_report(output_file=output_file, **kwargs)
...
def generate_rule_hit_count_report(
    ...
    **kwargs,
    ...
    _warn_deprecated_import()
    engine = ReportingEngine(tree, device_type, context_type, version)
    return engine.generate_rule_hit_count_report(output_file=output_file, **kwargs)
