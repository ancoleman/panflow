...
class ReportingEngine:
    ...
    def generate_security_policy_analysis(
        ...
        **kwargs
        ...
        # Save the report to a file if requested
        if output_file:
            self._save_report(analysis, output_file, output_format, "security_policy_analysis", include_hit_counts)
        ...
        try:
            ...
            if output_format.lower() == 'json':
                ...
                if report_type == "unused_objects":
                    ...
                    csv_data = self.csv_formatter.format_security_policy_analysis(data, include_hit_counts)
                ...
                if report_type == "unused_objects":
                    ...
                    html_data = self.html_formatter.format_security_policy_analysis(data, include_hit_counts)
