...
class HTMLFormatter:
    ...
    def format_security_policy_analysis(self, analysis_data: Dict[str, Any], include_hit_counts: bool = False) -> str:
        """
        ...
        """
        return self.template_loader.render_security_policy_analysis(analysis_data, include_hit_counts)
