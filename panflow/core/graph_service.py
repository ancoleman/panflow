...
class GraphService:
    ...
    def find_service_objects_with_port(self, tree: etree._ElementTree, port: str) -> List[str]:
        """
    ...
    def find_unused_objects(self, tree: etree._ElementTree, object_type: str) -> List[str]:
        """
