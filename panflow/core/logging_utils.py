...
def configure_logging(
    ...
    logger.debug(
        f"Logging configured: level={level}, log_file={log_file}, quiet={quiet}, verbose={verbose}, json_format={json_format}"
    )


def log_structured(message: str, level: str = "info", **kwargs) -> None:
    """
...
def log(message: str, level: str = "info", data: Optional[Dict[str, Any]] = None) -> None:
    """
