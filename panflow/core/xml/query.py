...
class XmlQuery:
    ...
    def get_nodes(self) -> List[XmlNode]:
        ...
        """
        return [XmlNode(elem) for elem in self.results if isinstance(elem, etree._Element)]
    ...
    def to_dicts(self, include_attributes: bool = True) -> List[Dict[str, Any]]:
        ...
        return [element_to_dict(elem) for elem in self.results if isinstance(elem, etree._Element)]
