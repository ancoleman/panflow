...
def update_object(
    ...
    **kwargs
    ...
    xpath = get_object_xpath(
        object_type, device_type, context_type, version, name, **kwargs
    )
...
def filter_objects(
    ...
    **kwargs
    ...
    all_objects = get_objects(
        tree, object_type, device_type, context_type, version, **kwargs
    )
    ...
    logger.info(f"Filtered {len(all_objects)} objects down to {len(filtered_objects)} matching objects")
