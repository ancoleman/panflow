...
def test_get_context_xpath_panorama_device_group():
    ...
    assert result == "/config/devices/entry[@name='localhost.localdomain']/device-group/entry[@name='test-dg']"
...
def test_get_context_xpath_firewall_vsys():
    ...
    assert result == "/config/devices/entry[@name='localhost.localdomain']/vsys/entry[@name='vsys1']"
...
def test_get_object_xpath_device_group():
    ...
    result = get_object_xpath(
        "address", "panorama", "device_group", "10.1", 
        name="test-addr", device_group="test-dg"
    )
...
def test_get_policy_xpath_panorama_pre_rules():
    ...
    result = get_policy_xpath(
        "security_pre_rules", "panorama", "device_group", "10.1", 
        name="test-rule", device_group="test-dg"
    )
...
def test_get_policy_xpath_firewall_security_rules():
    ...
    result = get_policy_xpath(
        "security_rules", "firewall", "vsys", "10.1", 
        name="test-rule", vsys="vsys1"
    )
