...
def main():
    ...
    group.add_argument(
        ...
        help="Migrate a specific command in a file",
    )

    # Migration options
    parser.add_argument(
        "--validate", action="store_true", help="Validate the migration without applying it"
    )
    parser.add_argument(
        "--apply", action="store_true", help="Apply the migration (replace the original files)"
    )
